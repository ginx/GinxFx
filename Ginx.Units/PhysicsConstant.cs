...
namespace Ginx.Units
{
    ...
    public static class PhysicsConstant
    {
        ...
        /// </summary>
        public static readonly Amount Magnetic = new Amount(12.566370614 * Math.Pow(10, -7), ForceUnits.Newton * ElectricUnits.Ampere.Pow(-2));
        ...
        /// </summary>
        public static readonly Amount NewtonianGravitation = new Amount(6.67384 * Math.Pow(10, -11), LengthUnits.Meter.Pow(3) / MassUnits.KiloGram / TimeUnits.Second.Pow(2));
        ...
        /// </summary>
        public static readonly Amount StefanBoltzmann = new Amount(5.670373 * Math.Pow(10, -8), EnergyUnits.Watt * LengthUnits.Meter.Pow(-2) * TemperatureUnits.Kelvin.Pow(-4));
    }
}
